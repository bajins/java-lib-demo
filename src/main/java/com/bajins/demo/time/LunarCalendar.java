...
public class LunarCalendar {
    ...
    private void init(long timeInMillis) {
        if (timeInMillis > minTimeInMillis && timeInMillis < maxTimeInMillis) {
            ...
            this.maxDayInMonth = daysInLunarMonth != 0 ? daysInLunarMonth :
                    LunarCalendar.getLunarMonthDays(this.lunarYear, lunarMonth);
    ...
    private static int getLunarLeapDays(int lunarYear) {
        ...
        // 若该年没有闰月,返回0
        return LunarCalendar.getLunarLeapMonth(lunarYear) > 0 ?
                ((LunarCalendar.lunarInfo[lunarYear - 1899] & 0xf) == 0xf ? 30 : 29) : 0;
    }
    ...
    private static int getLunarMonthDays(int lunarYear, int lunarMonth) {
        ...
        int daysInLunarMonth = ((LunarCalendar.lunarInfo[lunarYear - 1900] & (0x10000 >> lunarMonth)) != 0) ?
                30 : 29;
